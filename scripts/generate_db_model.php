 ...
 * Put your code in {$generator->class->namespace}\\{$generator->class->name}
 */";
    ...
    $columnValues = new Scoop\ClassGen\ClassGenProperty( 'dBValuesArray', array_fill_keys ( array_keys ( $dBColumnsArray ), null ) );
    ...
    $coreGenerator->addProperty ( $columnValues );
